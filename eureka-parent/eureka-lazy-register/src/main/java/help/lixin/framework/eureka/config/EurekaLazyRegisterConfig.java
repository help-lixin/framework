...
import help.lixin.framework.eureka.serviceregistry.DisableEurekaAutoServiceRegistrationProcessor;
...
public class EurekaLazyRegisterConfig {
    ...
    public DisableEurekaAutoServiceRegistrationProcessor disableEurekaAutoServiceRegistrationProcessor() {
        return new DisableEurekaAutoServiceRegistrationProcessor();
    }
