package help.lixin.framework.code.generator.model;
...
public class CodeGeneratorInfo implements Serializable {
    ...
    public String getControllerProject() {
        return workDir + SEPARATOR + projectName + SEPARATOR + projectConfig.getControllerProject();
    }

    public String getServiceProject() {
        return workDir + SEPARATOR + projectName + SEPARATOR + projectConfig.getServiceProject();
    }

    public String getModelProject() {
        return workDir + SEPARATOR + projectName + SEPARATOR + projectConfig.getModelProject();
    }

    public String getMapperProject() {
        return workDir + SEPARATOR + projectName + SEPARATOR + projectConfig.getMapperProject();
    }

    public String getMapperXmlProject() {
        return workDir + SEPARATOR + projectName + SEPARATOR + projectConfig.getMapperXmlProject();
    }
}
